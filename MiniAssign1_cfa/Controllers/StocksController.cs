...
namespace MiniAssign1_cfa.Controllers
{
    public class StocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StoreID,ProductID,Quantity")] Stock stock)
        {
            ...
            ViewBag.ProductID = new SelectList(db.Products, "ProductID", "Product_Name", stock.ProductID);
            ViewBag.StoreID = new SelectList(db.Stores, "StoreID", "Store_Name", stock.StoreID);
            return View(stock);
        }
